...
player createDiaryRecord ["CL",["* 1.2.1.4","
  - FEATURE: None, still fixin' and tweakin'<br />
  - TODO: CODE: Move Infantry network procedures on clients <br />
  - TODO: CODE: Some GEAR fix<br />
"]];*/
...
"];
  ...
  _size=[0.7,0.7];
  _pos2=[3600,9090,0];
  _offset2=CTI_MARKERS_TOWN_AREA_RANGE*3;
  ...
  _marker setMarkerColorLocal "ColorBlack";
  _marker setMarkerAlphaLocal 0.7;
  _marker setMarkerTextLocal format ["A base is considered detected (and marked on map) if an enemy have been less than %1 meter from it", (CTI_BASE_AREA_RANGE)];
  _pos=[(_pos select 0),(_pos select 1)-_offset,0];
