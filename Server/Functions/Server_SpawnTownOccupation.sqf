...
if (_value >= 500) then { _occupation_size = _occupation_size + 8 };
...
switch (true) do {
	...
	case (_value > 450) : {
		_pool_units = [[["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 35], ["SOLDIERS_AT_MEDIUM", 1, 84], ["SOLDIERS_AT_HEAVY", 2, 75], ["SOLDIER_AA", 1], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG", 2], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1]], [["VEHICLES_LIGHT", 1, 27], ["VEHICLES_MEDIUM", 2, 45], ["VEHICLES_HEAVY", 2, 42], ["VEHICLES_AA_LIGHT", 1, 30]]];
	};
};
