...
[["CLIENT", _side], "Client_RemoveDefense", _defense] call CTI_CO_FNC_NetSend;


if (_defense isKindOf "StaticMortar") then { _defense addEventHandler ["Fired",{_this execVM "Addons\Strat_mode\Functions\SM_Handle_Arty_Round.sqf"} ]};
