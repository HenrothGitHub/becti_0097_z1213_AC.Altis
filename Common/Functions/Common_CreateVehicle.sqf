...
if (isNull _created) then {
	...
	if (_vehicle isKindOf "MBT_01_mlrs_base_F"|| _vehicle isKindOf "MBT_01_arty_base_F"|| _vehicle isKindOf "MBT_02_arty_base_F") then{_vehicle addEventHandler ["Fired",{_this execVM "Addons\Strat_mode\Functions\SM_Handle_Arty_Round.sqf"} ];};
