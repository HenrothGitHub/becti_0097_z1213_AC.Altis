...
class CTI_RscOptionsMenu {
	...
	class controls {
		...
		class CTI_Menu_Options_Music : CTI_Menu_Options_OnlineHelp {
			...
			action = "['onACPressed'] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_OptionsMenu.sqf'";
		};
...
class CTI_RscAircraftLoadoutMenu {
	movingEnable = 0;
	idd = 39000;
	onLoad = "uiNamespace setVariable ['cti_dialog_ui_aircraftloadoutmenu', _this select 0];['onLoad'] execVM 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
	onUnload = "uiNamespace setVariable ['cti_dialog_ui_aircraftloadoutmenu', nil]; ['onUnload'] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
	...
	class controls 
	{
		...
		class vehicle_select_list: RscListNBox
		{
			...
			// On vehicle selected
			onLBSelChanged = "['onVehicleListLBSelChanged', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
...
//			rowHeight = "1.0 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		...
		//	columns[] = { 0.01 , .99 };
			...
			onLBSelChanged = "['onLoadoutListLBSelChanged', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		...
		class weapon_list_1: RscCombo
		{
			...
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 0 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		...
		class weapon_list_2: weapon_list_1
		{
			idc = 39031;
			y = 0.423 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 1 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class weapon_list_3: weapon_list_1
		{
			idc = 39032;
			y = 0.467 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 2 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class weapon_list_4: weapon_list_1
		{
			idc = 39033;
			y = 0.511 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 3 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class weapon_list_5: weapon_list_1
		{
			idc = 39034;
			y = 0.555 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 4 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class weapon_list_6: weapon_list_1
		{
			idc = 39035;
			y = 0.599 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 5 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class weapon_list_7: weapon_list_1
		{
			idc = 39036;
			y = 0.643 * safezoneH + safezoneY;
			onLBSelChanged = "['onWeaponListLBSelChanged', _this , 6 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_1: RscCombo
		{
			...
			colorBackground[] = {0,0,0,0.7};
			itemBackground[] = {1,1,1,0.1};
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 0 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		...
		class magazine_list_2: magazine_list_1
		{
			idc = 39041;
			y = 0.423 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 1 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_3: magazine_list_1
		{
			idc = 39042;
			y = 0.467 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 2 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_4: magazine_list_1
		{
			idc = 39043;
			y = 0.511 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 3 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_5: magazine_list_1
		{
			idc = 39044;
			y = 0.555 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 4 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_6: magazine_list_1
		{
			idc = 39045;
			y = 0.599 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 5 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class magazine_list_7: magazine_list_1
		{
			idc = 39046;
			y = 0.643 * safezoneH + safezoneY;
			onLBSelChanged = "['onAmmoListLBSelChanged', _this , 6 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class select_weapon_1: RscButton
		{
			...
			text = "NO";
			action = "[ 'onWeaponMountPressed' , 39050 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_2: select_weapon_1
		{
			idc = 39051;
			y = 0.423 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39051 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_3: select_weapon_1
		{
			idc = 39052;
			y = 0.467 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39052 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_4: select_weapon_1
		{
			idc = 39053;
			y = 0.511 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39053 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_5: select_weapon_1
		{
			idc = 39054;
			y = 0.555 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39054 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_6: select_weapon_1
		{
			idc = 39055;
			y = 0.599 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39055 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class select_weapon_7: select_weapon_1
		{
			idc = 39056;
			y = 0.643 * safezoneH + safezoneY;
			action = "[ 'onWeaponMountPressed' , 39056 ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		...
		class accept_button: RscButton
		{
			...
			w = 0.0773437 * safezoneW;
			h = 0.055 * safezoneH;
			action = "['onAcceptPressed' ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
		class cancel_button: RscButton
		{
			...
			w = 0.0773437 * safezoneW;
			h = 0.055 * safezoneH;
			action = "['onCancelPressed' ] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_AircraftLoadoutMenu.sqf'";
		};
	};
};
